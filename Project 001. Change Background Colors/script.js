...
const colors = [
  ...
  function ChangeColor() {
    ...
    const nameSpan = document.querySelector('.color-name span');
    const hexSpan = document.querySelector('.color-hex span');
    const rgbSpan = document.querySelector('.color-rgb span');
    const bodyColor = document.querySelector('body');

    bodyColor.style.background = colors[index++].name;

    nameSpan.textContent = colors[index].name;
    hexSpan.textContent = colors[index].hex;
    rgbSpan.textContent = colors[index].rgb;
